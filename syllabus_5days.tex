...
{\small This workshop provides social scientists with a deep, practical understanding of large language models, from the fundamentals of how they encode and process language, through to cutting-edge research applications. Each module combines conceptual depth with hands-on exercises, building skills progressively.}
...
{\small\sffamily
\textbf{\textcolor{accent}{Module 1:} \textcolor{dark}{Foundations}} -- From Embeddings to Transformers

\textbf{\textcolor{accent}{Module 2:} \textcolor{dark}{From Models to Tools}} -- Post-Training $\cdot$ Prompting \& Reasoning $\cdot$ Evaluating Models

\textbf{\textcolor{accent}{Module 3:} \textcolor{dark}{Deploying for Research}} -- Fine-Tuning \& Deployment $\cdot$ Text Classification \& Validation

\textbf{\textcolor{accent}{Module 4:} \textcolor{dark}{Social Science Applications}} -- Information Extraction \& RAG $\cdot$ LLMs as Simulated Agents

\textbf{\textcolor{accent}{Module 5:} \textcolor{dark}{Agentic Workflows}} -- Agents \& Autonomous Workflows $\cdot$ Capstone Project
}
...
% MODULE 2
% ════════════════════════════════════════════════════════════
\section{MODULE 2: FROM MODELS TO TOOLS}
...
% MODULE 3
% ════════════════════════════════════════════════════════════
\section{MODULE 3: DEPLOYING FOR RESEARCH}
...
% MODULE 4
% ════════════════════════════════════════════════════════════
\section{MODULE 4: SOCIAL SCIENCE APPLICATIONS}
...
% MODULE 5
% ════════════════════════════════════════════════════════════
\section{MODULE 5: AGENTIC WORKFLOWS}
